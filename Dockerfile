...
RUN wget https://download.qt.io/archive/qt/6.2/6.2.4/submodules/qtbase-everywhere-src-6.2.4.tar.xz

RUN tar xf qtbase-everywhere-src-6.2.4.tar.xz
...
CMD ["build/basicVisual/basicVisual"]
